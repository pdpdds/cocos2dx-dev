...
{
	vel = ccpMult(vel, PTM_RATIO*10.0f);

	CCLog("count: %i", _scrollOffsets->count());

	CCObject* pObj = NULL;
	CCARRAY_FOREACH(_scrollOffsets, pObj)
	{
		CCParallaxScrollOffset *scrollOffset = (CCParallaxScrollOffset*)pObj;
