...
public:
	...
	int serializeOutgoingPacket(SFProtobufPacketImpl& packet, DataBuffer& Buffer, unsigned int& nWrittenBytes);
	int tryDeserializeIncomingPacket(DataBuffer& Buffer, SFProtobufPacketImpl*& pPacket, int& serviceId, unsigned int& nExtractedBytes);
	//@}
public:
	/** @name Serialization. **/
	/**
	...
	*/
	virtual int encodeOutgoingPacket(SFProtobufPacketImpl& packet) = 0;
	/**
	\param packet OutgoingPacket instance to encode.
	...
	*/
	virtual int frameOutgoingPacket(SFProtobufPacketImpl& packet, DataBuffer& Buffer, unsigned int& nWrittenBytes) = 0;
	//@}
	...
	*/
	virtual int tryDeframeIncomingPacket(DataBuffer& Buffer, SFProtobufPacketImpl*& pPacket, int& serviceId, unsigned int& nExtractedBytes) = 0;
	/**
	...
	*/
	virtual int decodeIncomingPacket(SFProtobufPacketImpl* pPacket, int& serviceId) = 0;
	/**
	...
	*/
	virtual void disposeIncomingPacket(SFProtobufPacketImpl* pPacket) = 0;
	//@}
