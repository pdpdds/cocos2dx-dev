...
void Terrain::draw() {
	...
	CCTexture2D* pTexture = getStripes()->getTexture();
...
void Terrain::generateStripes() {
    ...
    ccColor4F highlightColor = ccc4f(1, 1, 1, 0.3f);
    ...
    ccColor4F borderColor = ccc4f(0, 0, 0, 0.5f);
	...
	setStripes(CCSprite::createWithTexture(rt->getSprite()->getTexture()));
...
void Terrain::createBox2DBody() {
   ...
   // body->CreateFixture(&shape, 0);
	...
	b2ChainShape shape;
	shape.CreateLoop(b2vertices, nVertices);
	body->CreateFixture(&shape, 0);
